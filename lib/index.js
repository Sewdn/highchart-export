...
var _exportChart = function (processingDir, hcExportRequest, callback) {
    var outputChartName = hcExportRequest.filename,
        ...
        inputFormat = hcExportRequest.options ? 'js' : 'svg',
        input = hcExportRequest.options ? hcExportRequest.options : hcExportRequest.svg,
    ...
    fs.writeFile(baseSVGFile, input, function (svgErr) {
